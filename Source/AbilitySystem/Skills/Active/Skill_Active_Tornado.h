...
UCLASS()
class ABILITYSYSTEM_API ATornado : public AActor
{
	GENERATED_BODY()
...
UCLASS()
class ABILITYSYSTEM_API USkill_Active_Tornado : public USkill_Active_Base
{
	GENERATED_BODY()
...
protected:
	...
	TSet<FOwnerInterfaceType*>TargetsSet;

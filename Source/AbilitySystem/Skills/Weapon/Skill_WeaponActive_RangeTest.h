...
UCLASS()
class ABILITYSYSTEM_API ASkill_WeaponActive_RangeTest_Projectile : public AProjectileBase
{
	GENERATED_BODY()
...
UCLASS()
class ABILITYSYSTEM_API USkill_WeaponActive_RangeTest : public USkill_WeaponActive_Base
{
	GENERATED_BODY()
...
protected:
	...
	void MakeDamage(FOwnerInterfaceType * TargetCharacterPtr);

...
{
	if (OtherActor && OtherActor->IsA(FOwnerInterfaceType::StaticClass()))
	{
		auto OtherCharacterPtr = Cast<FOwnerInterfaceType>(OtherActor);
...
void USkill_WeaponActive_RangeTest::MakeDamage(FOwnerInterfaceType* TargetCharacterPtr)
{

 ...
 */
UCLASS()
class ABILITYSYSTEM_API UPlanetGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
protected:
	...
	FOwnerInterfaceType* CharacterInterfacePtr = nullptr;
	
	FOwnerType* CharacterPtr = nullptr;

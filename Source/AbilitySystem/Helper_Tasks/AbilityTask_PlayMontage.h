...
// ASC綁定的 会调用ASC上的模型
UCLASS()
class ABILITYSYSTEM_API UAbilityTask_ASCPlayMontage : public UAbilityTask
{
	GENERATED_BODY()
public:
	...
	static UAbilityTask_ASCPlayMontage* CreatePlayMontageAndWaitProxy(
...
UCLASS()
class ABILITYSYSTEM_API UAbilityTask_PlayMontage : public UAbilityTask
{
	GENERATED_BODY()
public:

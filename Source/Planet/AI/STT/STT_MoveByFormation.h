...
USTRUCT()
struct PLANET_API FStateTreeMoveByFormationTaskInstanceData
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_API FSTT_MoveByFormation : public FStateTreeAIActionTaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FStateTreeMoveByFormationTaskInstanceData;

...
EStateTreeRunStatus FSTT_DashToLeader::EnterState(
...
void FSTT_DashToLeader::ExitState(
	FStateTreeExecutionContext& Context,
	const FStateTreeTransitionResult& Transition
)const
{
...
EStateTreeRunStatus FSTT_DashToLeader::Tick(
	FStateTreeExecutionContext& Context,
...
FSTT_DashToLeader::FAITaskType* FSTT_DashToLeader::PerformGameplayTask(FStateTreeExecutionContext& Context) const
{
	FInstanceDataType& InstanceData = Context.GetInstanceData(*this);

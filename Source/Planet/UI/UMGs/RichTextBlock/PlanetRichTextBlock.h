...
class PLANET_API URichTextBlock_Button : public URichTextBlock
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_API URichTextBlock_Button_Helper : public UUserWidget
{
	GENERATED_BODY()
...
class PLANET_API URichTextBlockButtonDecorator : public URichTextBlockDecorator
{
	GENERATED_BODY()

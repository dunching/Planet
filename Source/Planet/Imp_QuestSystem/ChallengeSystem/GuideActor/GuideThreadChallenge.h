...
class PLANET_API AGuideThread_Challenge : public AQuestChain_Immediate
{
	GENERATED_BODY()
...
UCLASS()
class UStateTreeGuideChallengeThreadComponentSchema : public USTQuestChainComponentSchemaBase
{
	GENERATED_BODY()

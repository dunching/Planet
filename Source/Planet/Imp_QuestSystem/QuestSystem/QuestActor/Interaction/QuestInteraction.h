...
class PLANET_API AQuestInteraction : public AQuestInteractionBase
{
	GENERATED_BODY()
...
UCLASS()
class UStateTreeGuideInteractionComponentSchema : public USTQuestInteractionComponentSchemaBase
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_API UGuideInteractionSystemStateTreeComponent : public UQuestInteractionSystemSTComponentBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideInteraction_HumanCharacter_AI : public AQuestInteractionBase
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_API UGuideInteraction_HumanCharacter_AI_SystemStateTreeComponent : public
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideInteraction_ChallengeEntry : public AQuestInteractionBase
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_API UGuideInteraction_ChallengeEntry_SystemStateTreeComponent : public
	UGuideInteractionSystemStateTreeComponent
{
	GENERATED_BODY()

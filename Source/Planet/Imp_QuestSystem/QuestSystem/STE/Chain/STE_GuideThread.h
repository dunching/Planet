...
class PLANET_API USTE_GuideThread_Main : public USTE_GuideThread_MainBase
{
	GENERATED_BODY()
...
#pragma region 支线
UCLASS(Blueprintable)
class PLANET_API USTE_GuideThread_Brand : public USTE_GuideThread_BrandBase
{
	GENERATED_BODY()
...
#pragma region 区域
UCLASS(Blueprintable)
class PLANET_API UGloabVariable_GuideThread_Area : public UGloabVariable_GuideThread_AreaBase
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class PLANET_API USTE_GuideThread_Area : public USTE_GuideThread_AreaBase
{
	GENERATED_BODY()
...
public:
	...
	TObjectPtr<AQuestChain_Area> GuideThreadAreaPtr = nullptr;

...
#include "GameplayTask_Quest.generated.h"
...
UCLASS()
class PLANET_API UGameplayTask_Quest : public UGameplayTask_QuestBase
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_API UGameplayTask_WaitInteractionSceneActor : public UGameplayTask_Quest
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_API UGameplayTask_WaitPlayerEquipment : public UGameplayTask_Quest
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_API UGameplayTask_WaitOpenLayout : public UGameplayTask_Quest
{
	GENERATED_BODY()

...
#include "QuestChainGameplayTask.generated.h"
...
UCLASS()
class PLANET_API UGameplayTask_Guide : public UGameplayTask_Quest
{
	GENERATED_BODY()
...
protected:
	TObjectPtr<AQuestChainBase> GuideActorPtr = nullptr;

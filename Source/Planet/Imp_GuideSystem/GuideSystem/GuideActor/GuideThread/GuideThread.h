...
class PLANET_API AGuideThread : public AGuideThreadBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideThread_Main : public AGuideThread_MainBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideThread_Branch : public AGuideThread_BranchBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideThread_Immediate : public AGuideThread_ImmediateBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideThread_Area : public AGuideThread_AreaBase
{
	GENERATED_BODY()

...
class PLANET_API AGuideInteraction : public AGuideInteractionBase
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_API UGuideInteractionSystemStateTreeComponent : public UGuideInteractionSystemStateTreeComponentBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideInteraction_HumanCharacter_AI : public AGuideInteractionBase
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType, Blueprintable)
class PLANET_API AGuideInteraction_ChallengeEntry : public AGuideInteractionBase
{
	GENERATED_BODY()

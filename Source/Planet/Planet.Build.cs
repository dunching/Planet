...
public class Planet : ModuleRules
{
	public Planet(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicIncludePaths.Add("Planet/UI/MainUI");
        PublicIncludePaths.Add("Planet/UI/MainUI/EffectsList");
        PublicIncludePaths.Add("Planet/UI/MainUI/HUD");
        PublicIncludePaths.Add("Planet/UI/MainUI/HUD/Team");
        PublicIncludePaths.Add("Planet/UI/MainUI/HUD/GetItemInfos");
        PublicIncludePaths.Add("Planet/UI/MainUI/PawnState");
        PublicIncludePaths.Add("Planet/UI/MainUI/PawnState/ActionStateHUD");
        PublicIncludePaths.Add("Planet/UI/MainUI/PawnState/BuildingStateHUD");

...
#include "BTTask_DashToLeader.generated.h"

class UAITask_DashToLeader;

struct FBTDashToLeaderTaskMemory
{
...
UCLASS()
class PLANET_API UBTTask_DashToLeader : public UBTTask_BlackboardBase
{
	GENERATED_BODY()

public:

	UBTTask_DashToLeader(const FObjectInitializer& ObjectInitializer);

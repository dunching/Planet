...
USTRUCT()
struct PLANET_API FGameplayAbilityTargetData_StateModify_Fear : 
	public FGameplayAbilityTargetData_StateModify
{
	GENERATED_USTRUCT_BODY()

	FGameplayAbilityTargetData_StateModify_Fear();
...
protected:
	...
	TSharedPtr<FMyPropertySettlementModify>MyPropertySettlementModify = nullptr;

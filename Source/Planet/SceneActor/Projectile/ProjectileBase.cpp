...
void AProjectileBase::SetSpeed_Implementation(
	float Speed
	)
{
	ProjectileMovementCompPtr->
		SetVelocityInLocalSpace(
		                        FVector::ForwardVector * Speed
		                       );
}

void AProjectileBase::SetHomingTarget_Implementation(
	ACharacterBase* TargetPtr
	)
{
...
void AProjectileBase::GetLifetimeReplicatedProps(

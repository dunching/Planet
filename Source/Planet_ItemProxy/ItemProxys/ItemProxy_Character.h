...
struct PLANET_ITEMPROXY_API FCharacterGrowthAttribute : public FTableRowBase
{
...
struct PLANET_ITEMPROXY_API FTalentHelper final
{
	GENERATED_USTRUCT_BODY()
...
UCLASS()
class PLANET_ITEMPROXY_API UItemProxy_Description_Character : public UItemProxy_Description
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct PLANET_ITEMPROXY_API FCharacterSocket
{
	GENERATED_USTRUCT_BODY()
 ...
 */
USTRUCT()
struct PLANET_ITEMPROXY_API FCharacterTalent
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct PLANET_ITEMPROXY_API FCharacterProxy :

...
UCLASS()
class PLANET_ITEMPROXY_API UItemProxy_Description_Skill : public UItemProxy_Description
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_ITEMPROXY_API FSkillProxy :
...
#pragma region 被动技能
UCLASS()
class PLANET_ITEMPROXY_API UItemProxy_Description_PassiveSkill : public UItemProxy_Description_Skill
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_ITEMPROXY_API FPassiveSkillProxy :
	public FSkillProxy,
...
#pragma region 主动技能
UCLASS()
class PLANET_ITEMPROXY_API UItemProxy_Description_ActiveSkill : public UItemProxy_Description_Skill
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_ITEMPROXY_API FActiveSkillProxy :
	public FSkillProxy,
	public IProxy_SkillState
{
	GENERATED_USTRUCT_BODY()
...
#pragma region 元素技能
USTRUCT()
struct PLANET_ITEMPROXY_API FTalentSkillProxy : public FSkillProxy
{
	GENERATED_USTRUCT_BODY()
...
#pragma region 武器技能
UCLASS()
class PLANET_ITEMPROXY_API UItemProxy_Description_WeaponSkill : public UItemProxy_Description_Skill
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_ITEMPROXY_API FWeaponSkillProxy : public FSkillProxy
{
	GENERATED_USTRUCT_BODY()

...
class PLANET_GUIDESYSTEM_API AGuideThread_Challenge : public AGuideThread_Immediate
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_GUIDESYSTEM_API UGuideChallengeThreadSystemStateTreeComponent : public UGuideThreadSystemStateTreeComponentBase
{
	GENERATED_BODY()

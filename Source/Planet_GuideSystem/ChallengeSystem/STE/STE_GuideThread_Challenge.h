...
class PLANET_GUIDESYSTEM_API UGloabVariable_GuideThread_Challenge : public UGloabVariable_GuideThreadBase
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class PLANET_GUIDESYSTEM_API USTE_TaskNode_GuideChallengeThread : public USTE_GuideThreadBase
{
	GENERATED_BODY()

...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadChallengeBase :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadChallengeBase :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadEntryNextLevel :
...
// 执行引导任务 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadEntryNextLevel :
...
struct PLANET_GUIDESYSTEM_API FSpawnNPCsHelper
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_Challenge_SpawnNPCs :
	public FSTID_GuideThreadChallengeBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_Challenge_SpawnNPCs :
	public FSTT_GuideThreadChallengeBase
{
	GENERATED_BODY()

...
class PLANET_GUIDESYSTEM_API UPAD_GuideThread_SpwanNPCColony : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadSpwanNPCColony :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadSpwanNPCColony :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadWaitCharacterDie :
	public FSTID_GuideThreadBase
{
	GENERATED_BODY()
...
// 执行引导任务 等待目标NPC死亡
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadWaitCharacterDie :
	public FSTT_GuideThreadBase
{
	GENERATED_BODY()

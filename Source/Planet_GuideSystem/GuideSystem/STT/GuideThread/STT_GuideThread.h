...
#pragma region Base
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread :
...
// 执行引导任务 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_PressKey :
...
// 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_PressKey :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_OpenLayout :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_OpenLayout :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_ActiveDash :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_ActiveDash :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_Run :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_Run :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_ShowCursor :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_ShowCursor :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
class PLANET_GUIDESYSTEM_API UPAD_GuideThread_GoToTheTargetPoint : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_GoToTheTargetPoint :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_GoToTheTargetPoint :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadDistributeRewards :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行任务 获取奖励
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadDistributeRewards :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
#pragma region 独白
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadMonologue :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 对话
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadMonologue :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_WaitComplete :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 等待完成
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_WaitTaskComplete :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
class PLANET_GUIDESYSTEM_API UPAD_GuideThread_WaitInteractionSceneActor : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_WaitInteractionSceneActor :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 等待完成
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_WaitInteractionSceneActor :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadCollectResource :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 要求玩家采集指定类型的资源
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadCollectResource :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadDefeatEnemy :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 要求玩家击败指定类型的敌人
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadDefeatEnemy :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
class PLANET_GUIDESYSTEM_API UPAD_GuideThread_ChangeNPCsInteractionList : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_ChangeNPCsInteractionList :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_ChangeNPCsInteractionList :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
class PLANET_GUIDESYSTEM_API UPAD_GuideThread_LeaveHere : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadLeaveHere :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 给目标角色添加互动引导内容
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadLeaveHere :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
class PLANET_GUIDESYSTEM_API UPAD_GuideThread_CheckIsInValidArea : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadCheckIsInValidArea :
	public FSTID_GuideThread
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTGT_GuideThreadCheckIsInValidArea :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThreadReturnOpenWorld :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 给目标角色添加互动引导内容
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThreadReturnOpenWorld :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_WaitPlayerEquipment :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 给目标角色添加互动引导内容
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_WaitPlayerEquipment :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_SpawnNPC :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 给目标角色添加互动引导内容
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_SpawnNPC :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_AttckCharacter :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 给目标角色添加互动引导内容
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_AttckCharacter :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
#pragma region 未完待续
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_ToBeContinued :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
// 执行引导任务 给目标角色添加互动引导内容
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_ToBeContinued :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
#pragma region 引导完成
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideThread_Completet :
	public FSTID_GuideThread
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideThread_Completet :
	public FSTT_GuideThread
{
	GENERATED_BODY()
...
#pragma region 延迟任务
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_DelayTask :
	public FSTID_GuideThread
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_DelayTask :
	public FSTT_GuideThread
{
	GENERATED_BODY()

...
// 与 NPC交互的任务 基类
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideInteractionTask :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideInteraction :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideInteraction_BackToRegularProcessor :

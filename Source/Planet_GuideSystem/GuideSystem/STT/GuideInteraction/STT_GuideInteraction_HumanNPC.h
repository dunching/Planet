...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideInteractionOption :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideInteractionOption :
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideInteractionConversation :
	public FSTID_GuideInteractionTask
{
	GENERATED_BODY()
...
// 与 NPC交互的任务 对话
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideInteractionConversation :
	public FSTT_GuideInteractionBase
{
	GENERATED_BODY()
...
class PLANET_GUIDESYSTEM_API UPAD_GuideInteraction_ChangeNPCsInteractionList : public UDataAsset
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideInteraction_ChangeNPCsTaskState :
	public FSTID_GuideInteractionTask
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideInteraction_ChangeNPCsTaskState :
	public FSTT_GuideInteractionBase
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTID_GuideInteraction_Transaction :
	public FSTID_GuideInteractionTask
{
	GENERATED_BODY()
...
USTRUCT()
struct PLANET_GUIDESYSTEM_API FSTT_GuideInteraction_Transaction :
	public FSTT_GuideInteractionBase
{
	GENERATED_BODY()

...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Interaction  : public UGameplayTask_Base
{
	GENERATED_BODY()
...
public:
	...
	void SetGuideInteractionActor(AGuideInteractionBase* InTargetCharacterPtr);
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Interaction_Conversation : public UGameplayTask_Interaction
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Interaction_Option : public UGameplayTask_Interaction
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Interaction_Transaction : public UGameplayTask_Interaction
{
	GENERATED_BODY()

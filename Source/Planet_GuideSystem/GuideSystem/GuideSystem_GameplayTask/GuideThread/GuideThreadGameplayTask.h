...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide : public UGameplayTask_Base
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_MoveToLocation : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_WaitInputKey : public UGameplayTask_Guide
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_Monologue : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_AddToTarget : public UGameplayTask_Guide
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_ConversationWithTarget : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_WaitComplete : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_CollectResource : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_DefeatEnemy : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_ReturnOpenWorld : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_ActiveDash : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_ActiveRun : public UGameplayTask_Guide
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Guide_AttckCharacter : public UGameplayTask_Guide
{
	GENERATED_BODY()

...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_Base : public UGameplayTask_GuideTask_Base
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_WaitInteractionSceneActor : public UGameplayTask_Base
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_WaitPlayerEquipment : public UGameplayTask_Base
{
	GENERATED_BODY()
...
UCLASS()
class PLANET_GUIDESYSTEM_API UGameplayTask_WaitOpenLayout : public UGameplayTask_Base
{
	GENERATED_BODY()

    ...
    Super(ObjectInitializer)
{
	...
	PawnPropertyComponentPtr = CreateDefaultSubobject<UTrackVehiclePawnPropertyComponent>(UPawnIteractionComponent::ComponentName);
...
UTrackVehiclePawnPropertyComponent::UTrackVehiclePawnPropertyComponent(const FObjectInitializer& ObjectInitializer) :
	Super(ObjectInitializer)
{

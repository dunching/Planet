    ...
    Super(ObjectInitializer)
{
    ...
    {
        auto StaticMeshPtr = LoadObject<UStaticMesh>(this, TEXT("StaticMesh'/Game/ShiYu/GamePlay/SceneObj/Track/Track1.Track1'"));
	...
	{
		auto StaticMeshPtr = LoadObject<UStaticMesh>(this, TEXT("StaticMesh'/Game/ShiYu/GamePlay/SceneObj/Track/Track2.Track2'"));
	...
	{
		auto StaticMeshPtr = LoadObject<UStaticMesh>(this, TEXT("StaticMesh'/Game/ShiYu/GamePlay/SceneObj/Track/Track3.Track3'"));

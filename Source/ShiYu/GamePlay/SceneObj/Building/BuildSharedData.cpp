...
void ABuildingCaptureData::StartOverlapCheck(EBuildingType ItemsType)
{
...
TSharedPtr<FCapturesInfo> ABuildingCaptureData::GetCaptureAry(EBuildingType ItemsType) const
{

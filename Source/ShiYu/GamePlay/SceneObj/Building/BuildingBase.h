...
UCLASS()
class SHIYU_API UStateSwitchComponent : public UActorComponent
{
	GENERATED_BODY()
...
UCLASS()
class SHIYU_API UBuildingPropertyComponent : public USceneObjPropertyComponent
{
	GENERATED_BODY()
...
UCLASS()
class SHIYU_API ABuildingBase : public ASceneObj
{
	GENERATED_BODY()

...
UCLASS()
class PLANET_NPCGENERATOR_API UFormationComponent : public USceneComponent
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_NPCGENERATOR_API AGeneratorColonyWithPath : public APlanetGenerator
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_NPCGENERATOR_API AGeneratorNPCs_Patrol : public APlanetGenerator
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PLANET_NPCGENERATOR_API AGeneratorColony_ByInvoke : public APlanetGenerator
{
	GENERATED_BODY()

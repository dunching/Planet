...
UCLASS()
class SCENEOBJECTS_API UStateSwitchComponent : public UActorComponent
{
	GENERATED_BODY()
...
UCLASS()
class SCENEOBJECTS_API UBuildingPropertyComponent : public USceneObjPropertyComponent
{
	GENERATED_BODY()
...
UCLASS()
class SCENEOBJECTS_API ABuildingBase : public ASceneObj
{
	GENERATED_BODY()

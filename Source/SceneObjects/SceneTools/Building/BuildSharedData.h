...
class SCENEOBJECTS_API UCaptureSockComponent : public USceneComponent
{
	GENERATED_BODY()
...
UCLASS(Blueprintable, BlueprintType)
class SCENEOBJECTS_API UCustomChildActorComponent : public UChildActorComponent
{
	GENERATED_BODY()
...
UCLASS()
class SCENEOBJECTS_API ABuildingCaptureData : public AActor
{
	GENERATED_BODY()

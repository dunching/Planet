	...
	)
{
	...
	{
		GetMyMoveResponseDataContainer()->bPathFollow = bHasRequestedVelocity;
	}
...
{
	{
		...
		if (GetMyMoveResponseDataContainer()->bPathFollow)
		{
		}
		else
		{
	...
	)
{
	...
	{
		bHasRequestedVelocity = MyMoveResponsePtr->bPathFollow;
	}
...
FMyCharacterMoveResponseDataContainer* UGravityMovementComponent::GetMyMoveResponseDataContainer() const
{

...
#include "STE_InteractionBase.generated.h"
...
class GUIDESYSTEM_API UGloabVariable_InteractionBase : public UObject
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class GUIDESYSTEM_API USTE_InteractionBase : public USTE_Base
{
	GENERATED_BODY()

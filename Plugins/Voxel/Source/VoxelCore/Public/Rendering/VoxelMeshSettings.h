...
#include "VoxelMeshSettings.generated.h"

class UVoxelMeshComponent;

USTRUCT(BlueprintType)
struct VOXELCORE_API FVoxelMeshSettings : public FVoxelOverridableSettings
{
	GENERATED_BODY()
	...
	FVoxelMeshSettings() = default;

	void ApplyToComponent(UVoxelMeshComponent& Component) const;
};
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "MMT Get Scene Component Reference by Name"), Category = "MMT Utility")
		static USceneComponent* GetSceneComponentReferenceByName(UActorComponent* Target, FString Name);
